...
$expectedActions = [
	...
	'ztum.templates.install_batch' => ['class' => 'TemplateInstallBatch', 'view' => 'template.install.batch'],
...
$requiredFiles = [
	...
	$root.'/actions/TemplateInstallBatch.php',
	$root.'/views/template.install.batch.php',
