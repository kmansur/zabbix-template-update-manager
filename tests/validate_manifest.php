...
$expectedActions = [
	...
	'ztum.templates.update_policy' => ['class' => 'TemplateUpdatePolicy'],
	...
	'ztum.templates.batch_update' => ['class' => 'TemplateBatchUpdate', 'view' => 'ztum.template.batch.update'],
	'ztum.templates.install_prepare_selected' => ['class' => 'TemplateInstallBatchPrepare', 'view' => 'ztum.template.install.batch.prepare'],
	...
	'ztum.template.install.review' => ['class' => 'TemplateInstallReview', 'view' => 'ztum.template.install.review'],
	'ztum.template.install' => ['class' => 'TemplateInstall', 'view' => 'ztum.template.install'],
	'ztum.template.compare' => ['class' => 'TemplateCompare', 'view' => 'ztum.template.compare'],
	'ztum.template.backup' => ['class' => 'TemplateBackup'],
	'ztum.template.backups' => ['class' => 'TemplateBackupList', 'view' => 'ztum.template.backup.list'],
	'ztum.template.preflight' => ['class' => 'TemplatePreflight', 'view' => 'ztum.template.preflight'],
	'ztum.template.update' => ['class' => 'TemplateUpdate', 'view' => 'ztum.template.update'],
	'ztum.template.rollback.review' => ['class' => 'TemplateRollbackReview', 'view' => 'ztum.template.rollback.review'],
...
$requiredFiles = [
	...
	$root.'/actions/TemplateOperationHistory.php',
	$root.'/views/ztum.operation.history.php',
	$root.'/src/Repository/TemplateOperationHistoryRepository.php',
	$root.'/src/Service/TemplateOperationHistoryService.php',
	...
	$root.'/views/ztum.template.install.review.php',
	$root.'/actions/TemplateInstall.php',
	$root.'/views/ztum.template.install.php',
	$root.'/actions/TemplateCompare.php',
	$root.'/views/ztum.template.compare.php',
	$root.'/actions/TemplateBackup.php',
	$root.'/actions/TemplateBackupList.php',
	$root.'/views/ztum.template.backup.list.php',
	$root.'/actions/TemplatePreflight.php',
	$root.'/views/ztum.template.preflight.php',
	$root.'/actions/TemplateUpdate.php',
	$root.'/views/ztum.template.update.php',
	$root.'/actions/TemplateRollbackReview.php',
	$root.'/views/ztum.template.rollback.review.php',
	$root.'/actions/TemplateRollback.php',
	$root.'/views/ztum.template.rollback.php'
];
